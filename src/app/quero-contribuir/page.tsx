  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="bg-[#4a2f24]">
        <div className="max-w-215 mx-auto px-6 py-14 text-center">
          <div
            className="inline-flex items-center gap-2 bg-white/10 text-[#f9f5f2] text-[12px] px-3 py-1.5 rounded-full mb-4"
            style={{ fontWeight: 500 }}
          >
          ...
          <h1
            className="text-[#f9f5f2] text-[30px] md:text-[36px] mb-3"
            style={{ fontWeight: 600, lineHeight: 1.3 }}
          >
            Contribua com a construção do nosso Centro Pastoral
          </h1>
          <p
            className="text-[#dcc2b5] text-[16px] max-w-135 mx-auto"
      ...
      <div className="max-w-215 mx-auto px-6 py-12 space-y-10">
        {/* ── PIX Section ─────────────────────────────────────── */}
        <section>
          <h2
            className="text-[#1a1a1a] text-[20px] mb-6"
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-6 border-b border-[#f0f0f0]">
              <p
                className="text-[11px] text-[#7b4f37] uppercase tracking-widest mb-4"
                style={{ fontWeight: 600 }}
              >
                Chave PIX — Telefone
              </p>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex-1">
                  ...
                  <p
                    className="text-[#1a1a1a] text-[28px] tracking-tight"
                    style={{
                      fontWeight: 700,
            ...
            <div className="p-6 border-b border-[#f0f0f0]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  <p className="text-[#6b7280] text-[12px] mb-0.5">
                    Conta Corrente
                  </p>
                  <p
                    className="text-[#1a1a1a] text-[15px]"
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
                <div className="shrink-0 bg-white border border-[#e5e7eb] rounded-xl p-3">
                  <img
                    src="/MacBookPro1412/0387079cf701d07a2fd68e5f432a1d50030fb66c.png"
                ...
                <div className="flex flex-col gap-4 justify-center">
                  <p
                    className="text-[#2b2b2b] text-[14px]"
                    style={{ lineHeight: 1.7 }}
                  >
                    Abra o app do seu banco, vá em{" "}
                    <strong>Pix → Ler QR Code</strong> e aponte a câmera para o
                    código ao lado.
                  </p>
                  <div className="bg-[#f9f5f2] border border-[#dcc2b5]/60 rounded-xl p-4">
                    <p
                      className="text-[#7b4f37] text-[13px] mb-2"
                      style={{ fontWeight: 600 }}
                    >
        ...
        <section className="border-t border-[#f0f0f0] pt-10">
          ...
          <p
            className="text-[#6b7280] text-[15px] mb-4"

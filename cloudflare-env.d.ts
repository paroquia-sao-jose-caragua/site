...
// Runtime types generated with workerd@1.20260611.1 2026-06-11 global_fetch_strictly_public,nodejs_compat
...
interface BasicImageTransformations {
  ...
  /**
   * img segmentation using artificial intelligence models. Sets pixels not
...
interface ImageHandle {
   ...
   * @returns img metadata, or null if not found
   */
